        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Auditors_Companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Surveyers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Surveyers_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppartmentArea = table.Column<int>(type: "int", nullable: true),
                    ...
                    SurveyerId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AppartmentType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appartments_Requests_RequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UploadFiles_Requests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "Requests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "AppartmentAreas",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AvailableAppartmentAreas = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AppartmentId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppartmentAreas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppartmentAreas_Appartments_AppartmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppartmentAreas_AppartmentId",
                table: "AppartmentAreas",
                column: "AppartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_Appartments_RequestId",
                table: "Appartments",
                column: "RequestId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Surveyers_CompanyId",
                table: "Surveyers",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_UploadFiles_RequestId",
                table: "UploadFiles",
                column: "RequestId");
        }
